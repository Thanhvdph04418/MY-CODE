package you.fuck.i.ecommerceapp.model;
...
public class ProductModel {
    ...
    public ProductModel(int id_sanpham,String ten_sanpham,int gia_sanpham){
        this.id_sanpham = id_sanpham;
        this.gia_sanpham = gia_sanpham;
        this.ten_sanpham = ten_sanpham;
    }
    public ProductModel(String ten_sanpham,int gia_sanpham){
        this.gia_sanpham = gia_sanpham;
        this.ten_sanpham = ten_sanpham;
    }
