...
public class StudentDao {
    //chỉ làm các chức năng thêm lấy sửa xóa
    // mở CSDL và đóng CSDL
    private SQLiteDatabase db;// giúp thực thi các câu truy vẫn SQL
    ...
    public void deleteData(int id) {
        String statements = "DELETE FROM " + CreateDatabase.TABLE_NAME + "WHERE " + CreateDatabase.ID + " = " + id;
        db.execSQL(statements);
    }

    public void updateData(StudentModel st) {
        String statements = "UPDATE " + createDatabase.TABLE_NAME + " SET " + createDatabase.NAME + " = '  '" + st.getName() + "', "
